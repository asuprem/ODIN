...
class kerasComplex(mlep.learning_model.BaseLearningModel.BaseLearningModel):
    ...
    def __init__(self,):
        ...
        super(kerasComplex,self).__init__(model)
    ...
    def _fit(self,X,y,**kwargs):
        ...
        self._model.fit(X,to_categorical(y), epochs=2,batch_size=32,**kwargs)
